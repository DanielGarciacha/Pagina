...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2024 a las 23:55:57
...
--
ALTER TABLE `recomendaciones`
  ADD CONSTRAINT `recomendaciones_ibfk_1` FOREIGN KEY (`medico_id`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `recomendaciones_ibfk_2` FOREIGN KEY (`estudiante_id`) REFERENCES `usuarios` (`id`);
COMMIT;
